...
<body>
	...
	<form method="get" action="${urlSearch }">
		...
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				<li style="margin-top: 12px;">Khóa học : <span>${course.course_name }</span></li>
				<li style="margin-top: 12px; margin-left: 50px;">&nbsp;&nbsp;Giảng
					viên :<span>${course.teacher.teacher_name }</span>
				</li>
			</ul>
	...
	<div class="pagination">
		<a href="/springmvc/listStudent/1">1</a> <a
			href="/springmvc/listStudent/2">2</a> <a
			href="/springmvc/listStudent/3">3</a>
	</div>
